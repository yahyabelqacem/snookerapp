...
const [dataLoaded, setDataLoaded] = useState(false);
  ...
  const BallsRow = ({ balls }: { balls: { color: string }[] }) => (
    <div style={{ display: "flex", gap: 5, marginBottom: 10, overflowX: "auto", overflowY: "hidden", maxWidth: "100%", padding: "2px", scrollbarWidth: "none", flexWrap: "nowrap" }}>
      {balls.slice(-15).map((b, i) => {
  ...
  return (
    <div style={{
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", justifyContent: "center", padding: mainPadding }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 90px 1fr", gap: 16, alignItems: "start", marginBottom: 16 }}>
          ...
          <div style={{
            ...
            <div style={{ fontSize: scoreSize, fontWeight: 700, lineHeight: 1, color: "#fff", margin: "0 0 12px", textShadow: game.active === 0 ? "0 0 50px rgba(55,138,221,0.5)" : "none" }}>
              {game.score1}
            </div>
            <div style={{ fontSize: 14, color: "#555", marginBottom: 4 }}>
              Break <span style={{ color: game.active === 0 ? "#85B7EB" : "#666", fontSize: breakFontSize, fontWeight: 600 }}>{game.break1}</span>
            </div>
          ...
          <div style={{ textAlign: "center", paddingTop: 40 }}>
            ...
            <div style={{ fontSize: 9, color: "#333", marginTop: 2 }}>{leader !== null ? "leads" : ""}</div>
          </div>
          ...
          <div style={{
            ...
            <div style={{ fontSize: scoreSize, fontWeight: 700, lineHeight: 1, color: "#fff", margin: "0 0 12px", textShadow: game.active === 1 ? "0 0 50px rgba(216,90,48,0.5)" : "none" }}>
              {game.score2}
            </div>
            <div style={{ fontSize: 14, color: "#555", marginBottom: 4 }}>
              Break <span style={{ color: game.active === 1 ? "#F0997B" : "#666", fontSize: breakFontSize, fontWeight: 600 }}>{game.break2}</span>
            </div>
            <div style={{ fontSize: 12, color: "#333" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: 12 }}>
          ...
          <div style={{ display: "inline-flex", alignItems: "center", gap: 10, background: "rgba(0,0,0,0.5)", borderRadius: 30, padding: "8px 24px", border: "1px solid rgba(245,196,0,0.2)", boxShadow: "0 0 20px rgba(245,196,0,0.1)" }}>
            <span style={{ fontSize: 14, color: "#F5C400" }}>⏱</span>
            <span style={{ fontSize: 24, fontWeight: 600, color: "#F5C400", letterSpacing: 4, fontVariantNumeric: "tabular-nums", fontFamily: "monospace" }}>
              {elapsed}
            </span>
          </div>
        </div>
